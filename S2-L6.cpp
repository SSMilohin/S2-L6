...
//
// Т.к. операции удаления и добавления элементов не предусмотрены я выбрал массив с бинарным поиском, 
// поскольку он проще в реализации по сравнению с бинарным деревом, занимает меньше оперативной памяти,
// а бинарный поиск по массиву не уступает в скорости работы поиска по бинарному дереву.
//
